...
일반 Save에서 `UIToolkitAssetSerializer`는 Metadata를 저장하고 UXML 이름을 검증하지만, 기존 UXML 구조를 다시 쓰지 않습니다. `Sync Metadata From Backend`는 이름이 있는 VisualElement를 Metadata에 추가할 수 있습니다.
...
> [!WARNING]
> Toolbar의 일반 Save와 별도 UXML/USS Generation은 서로 다른 작업입니다.
